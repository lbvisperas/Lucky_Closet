                    ...
                    <div class="block">
                        <div class="block-header">
                            ...
                            <span class="col-lg-6" style="text-align: right;">
                                  <a class="btn btn-default btn-info btn-condensed btn-sm" data-toggle="tooltip" title="Add New Carousel" href="<?=base_url();?>account/add-slider"><span title="Add New Product"class="fa fa-plus"></span></a>
                            </span>
                        </div>
                    ...
                    <div class="block-content">
                            <table class="table table-bordered table-striped js-dataTable-full">
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                        <td><?=$value->id?></td>
                                        <td><img height="125px" width="125px" src="<?=base_url();?>upload/slider/<?=$value->id?>/<?=$value->name;?>"></td>
