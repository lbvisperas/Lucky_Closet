                    ...
                    <div class="block">
                        <div class="block-header">
                            ...
                            <span class="col-lg-6" style="text-align: right;">
                                <a class="btn btn-default btn-rounded btn-condensed btn-sm" data-toggle="tooltip" title="Add Main Category" href="<?=base_url();?>account/category-add"><span title="Add Sub Category"class="fa fa-plus"></span></a>
                            </span>
                        </div>
                                ...
                                <tbody>
                                   ...
                                   <tr> 
                                    ...
                                    <td style="text-transform: capitalize;">
                                        ...
                                        ?></td>
                                    <td>
                                       <a class="btn btn-default btn-rounded btn-condensed btn-sm btn-success" type="button" data-toggle="tooltip"  title="Edit Sub Category" href="<?=site_url('account/edit-subcategory/'.$post->subcat_id)?>">Edit</a> 
                                       <a href="<?= base_url() . 'account/sub-category-delete/' . $post->subcat_id ?>" data-href="" class="btn btn-danger btn-rounded btn-condensed btn-sm delete"  data-toggle="tooltip" title="Delete Sub Category" ><span class="fa fa-times" title="delete"></span></a>
                                    </td>
                                   </tr>
                                    <?php }?>
                                </tbody>
