                                ...
                                <div class="block-content block-content-full bg-gray-lighter ">
                                      <form class="form-horizontal"  method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <input class="form-control" type="text" id="product_name" value="<?php echo set_value('category_name'); ?>" name="category_name" placeholder="Category Name" >
                                       ...
                                       <div class="form-group">
                                            <div class="col-md-8 col-md-offset-2">
                                                <button class="btn btn-sm btn-danger" name="submit" type="submit"><i class="fa fa-check"></i> Add Category</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
