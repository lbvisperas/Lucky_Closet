                                    ...
                                    ?>
                                      <form class="form-horizontal"  method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <input class="form-control" type="text" id="product_name" value="<?=$post->category_name?>" name="category_name" placeholder="Category Name" >
                                                 <div style="margin-top: 0px; color: red;"><?= form_error('category_name'); ?></div>
                                                 <input type="hidden" value="<?=$post->id?>" name="category_id" /> 
                                            </div>
                                        </div>
                                        
                                       <div class="form-group">
                                            <div class="col-md-8 col-md-offset-2">
                                                <button class="btn btn-sm btn-danger" name="submit" type="submit"><i class="fa fa-check"></i> Edit Category Submit</button>
                                            </div>
                                        </div>
                                    </form>
                                    <?php }?>
