				...
				<!-- First Panel -->
					<div class="panel panel-default">
						...
						<div id="collapseOne" class="panel-collapse collapse">
							<div class="panel-body">
								<p>Delivery charges are expected to be at around Php 50-100 in Manila, and Php 200-300 in provinces, depending on the location. The delivery would be taken care by courier services in the Philippines.</p>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-default">
						...
						<div id="collapseTwo" class="panel-collapse collapse">
							<div class="panel-body">								
								<p>Orders usually take around a week to arrive, depending on the courier.</p>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-default">
						...
						<div id="collapseThree" class="panel-collapse collapse">
							<div class="panel-body">
								<p>Around 3-5 days, but we cannot guarantee since we are reliant on courier services.</p>
							</div>
						</div>
					</div>
					<!-- Fourth Panel -->
					<div class="panel panel-default">
						...
						<div id="collapseFour" class="panel-collapse collapse">
							<div class="panel-body">
								<p>As of now, we only cater to the Philippines.</p>
							</div>
						</div>
					</div>					
				</div>
