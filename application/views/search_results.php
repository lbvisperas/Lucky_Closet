...
<div class="banner-top">
    <div class="container">
            ...
            <h4><a href="<?=base_url();?>">Home</a><label>/</label>Search Products</h4>
		...
		<div class="container">
			...
			<div class=" con-w3l">
				...
				<div class="col-md-3 pro-1">
					<div class="col-m">
					        <a class="offer-img quicklook" id="<?=$product['id']?>" style="text-align: center; cursor: pointer;">
								<img height="125px" width="100%" src="<?=base_url();?>/upload/product/<?=$product['id'];?>/<?=$product['product_image'];?>"  alt="">
							</a>
							<div class="mid-1">
								<div class="women">
                                    <h6><a style="text-transform: capitalize;" href="<?= base_url();?>ProductDetail/<?=$product['id']?>"><?=$product['product_name']?></a></h6>							
								</div>
								<div class="mid-2">
                                    <p style="color: #666666;"><em class="item_price">Php <?=$product['product_price']?></em></p>
									<div class="block">
				...
				<?php }
                    ...
                    echo "Search item not available in our database.";
                }?>
            <div class="clearfix"></div>
			</div>	
		</div>
